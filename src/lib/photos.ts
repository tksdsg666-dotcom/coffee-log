...
export const photoUri = (filename: string | null | undefined): string | null =>
...
export const deletePhoto = (filename: string | null | undefined): void => {
  if (!filename) return;
  try {
...
/** Filenames currently on disk — used by the export/import housekeeping. */
